...
function initTable() {
  layui.use(['table'], function () {
    ...
    table.render({
      ...
      id: 'compnayList',
      cols: [[{ field: '_id', width: 80, title: '', sort: false, templet: function templet(d) {
          return d.LAY_INDEX;
        } }, { field: 'company', width: 250, title: '公司' }, { field: 'alias', width: 150, title: '別名', sort: false }, { field: 'addr', title: '地址', minWidth: 250 }, { field: 'city', width: 80, title: '城市', sort: false }, { field: 'district', width: 90, title: '区域' }, { field: 'bdStatus', width: 92, title: '审核状态', templet: function templet(d) {
